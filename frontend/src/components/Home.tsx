...
const feature_images = [
  { path: "feature_transacao.png", alt: "transação", msg: "Com PatrimoniX, sua gestão de ativos fica mais fácil" },
  { path: "feature_dashboard.png", alt: "dashboard", msg: "Veja a evolução da sua carteira em detalhes" },
