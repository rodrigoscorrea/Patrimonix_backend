          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              ...
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
                ...
                {totalAtivos === 0
                  ? 0
                  : ((totalAtivosAcao / totalAtivos) * 100).toFixed(2)}
                %
              </span>
              <i className="bi bi-grip-vertical"></i>
              <span
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              ...
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
                ...
                {totalAtivos === 0
                  ? 0
                  : ((totalAtivosFII / totalAtivos) * 100).toFixed(2)}
                %{" "}
              </span>
              <i className="bi bi-grip-vertical"></i>
              <span
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              ...
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
                ...
                {totalAtivos === 0
                  ? 0
                  : ((totalAtivosETF / totalAtivos) * 100).toFixed(2)}
                %{" "}
              </span>
              <i className="bi bi-grip-vertical"></i>
              <span
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              ...
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
                ...
                {totalAtivos === 0
                  ? 0
                  : ((totalAtivosBDR / totalAtivos) * 100).toFixed(2)}
                %{" "}
              </span>
              <i className="bi bi-grip-vertical"></i>
              <span
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              ...
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
                ...
                {totalAtivos === 0
                  ? 0
                  : ((totalAtivosOutros / totalAtivos) * 100).toFixed(2)}
                %{" "}
              </span>
              <i className="bi bi-grip-vertical"></i>
              <span style={{ fontSize: "1.4 em", fontWeight: "600" }}>
